      ...
      <Card style={{ marginBottom:'20px' }}>
        ...
        <div style={{ display:'flex', gap:'10px', flexWrap:'wrap', alignItems:'flex-end' }}>
          <div style={{ display:'flex', flexDirection:'column', gap:'5px' }}>
            ...
            <select value={ctxSchool} onChange={e => { setCtxSchool(e.target.value); setCtxClass(''); setSelectedClass(''); setChecked(new Set()) }} style={selSt}>
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:'5px' }}>
            ...
            <select value={ctxYear} onChange={e => { setCtxYear(e.target.value); setCtxClass(''); setSelectedClass(''); setChecked(new Set()); setCtxTerm('') }} style={selSt}>
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:'5px' }}>
            ...
            <select value={ctxTermType} onChange={e => { setCtxTermType(e.target.value); setCtxTerm(''); setCtxClass(''); setSelectedClass(''); setChecked(new Set()) }} style={selSt}>
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:'5px' }}>
            ...
            <select value={ctxTerm} onChange={e => { setCtxTerm(e.target.value); setCtxClass(''); setSelectedClass(''); setChecked(new Set()) }} style={selSt}>
              <option value="">전체</option>
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:'5px' }}>
            ...
            <select value={ctxClass} onChange={e => { setCtxClass(e.target.value); setSelectedClass(e.target.value); setChecked(new Set()); setPhase('setup') }} style={selSt}>
              <option value="">전체 수업</option>
              {classOptions.map(opt => <option key={opt.value} value={opt.value}>{opt.label}</option>)}
            </select>
          </div>
          {(ctxYear || ctxSchool || ctxTermType) && (
            <button onClick={() => { setCtxYear(''); setCtxSchool(''); setCtxTermType(''); setCtxTerm(''); setCtxClass(''); setSelectedClass(''); setChecked(new Set()) }}
