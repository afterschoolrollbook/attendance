...
const DEFAULT_GUIDES = [
  // 결석
  { category:'결석', title:'결석 안내 (기본)', content:'안녕하세요, {학교명} {수업명} {선생님닉네임}입니다 😊
{학생이름} 친구가 오늘 수업에 아직 도착하지 않아 연락드립니다.
혹시 결석 예정이신가요? 확인 부탁드립니다. 감사합니다 🙏' },
  { category:'결석', title:'결석 안내 (간단)', content:'안녕하세요 {학교명} {선생님닉네임}입니다.
{학생이름} 학생이 {날짜} 수업에 결석 처리되었습니다.
문의사항은 언제든지 연락주세요.' },
  // 지각
  { category:'지각', title:'지각 안내 (기본)', content:'안녕하세요, {학교명} {수업명} {선생님닉네임}입니다 😊
{학생이름} 친구가 오늘 수업에 늦게 도착했습니다.
수업은 잘 참여하고 있으니 안심하세요 😄' },
  { category:'지각', title:'지각 안내 (확인 요청)', content:'안녕하세요 {학교명} {선생님닉네임}입니다.
{학생이름} 학생이 {날짜} 수업에 지각하였습니다.
다음에는 정시에 올 수 있도록 부탁드립니다. 감사합니다 🙏' },
  // 개강전
  { category:'개강전', title:'개강 전 안내 (기본)', content:'안녕하세요, {학교명} {수업명} {선생님닉네임}입니다 😊
곧 새 학기 수업이 시작됩니다!
첫 수업 날짜와 준비물을 안내해드릴게요. 기대해주세요 🎉' },
  { category:'개강전', title:'개강 전 안내 (준비물)', content:'안녕하세요 {학교명} {선생님닉네임}입니다.
{학생이름} 학생의 {수업명} 수업이 곧 시작됩니다.
준비물: (직접 입력)
첫 수업일: (직접 입력)
궁금한 점은 언제든지 연락주세요 😊' },
  // 개강
  { category:'개강', title:'개강 알림 (기본)', content:'안녕하세요, {학교명} {수업명} {선생님닉네임}입니다 🎉
오늘 {날짜}부터 수업이 시작됩니다!
{학생이름} 친구와 즐겁고 알찬 시간 보내겠습니다. 잘 부탁드립니다 😄' },
  { category:'개강', title:'개강 알림 (환영)', content:'안녕하세요 {학교명} {선생님닉네임}입니다.
{수업명} 수업 개강을 진심으로 환영합니다! 🎊
{학생이름} 학생이 즐겁게 배울 수 있도록 최선을 다하겠습니다.
감사합니다 🙏' },
  // 수업신청감사
  { category:'수업신청감사', title:'신청 감사 (기본)', content:'안녕하세요, {학교명} {수업명} {선생님닉네임}입니다 😊
{학생이름} 학생의 수업 신청 감사드립니다 🙏
수업 관련 안내는 추후 별도로 연락드리겠습니다. 기대해주세요!' },
  { category:'수업신청감사', title:'신청 감사 (확정 안내)', content:'안녕하세요 {학교명} {선생님닉네임}입니다.
{학생이름} 학생의 {수업명} 수업 신청이 완료되었습니다 ✅
수업 시작 전 안내사항은 별도로 연락드리겠습니다.
신청해주셔서 감사합니다 😄' },
  // 추첨
  { category:'추첨', title:'추첨 당첨 알림', content:'안녕하세요, {학교명} {수업명} {선생님닉네임}입니다 🎉
{학생이름} 학생이 {날짜} 추첨 결과 최종 선발되었습니다! 🎊
수업 관련 안내는 추후 연락드리겠습니다. 감사합니다 🙏' },
  { category:'추첨', title:'추첨 대기 알림', content:'안녕하세요 {학교명} {선생님닉네임}입니다.
{학생이름} 학생께서 {날짜} 추첨에서 대기자로 등록되셨습니다.
결원 발생 시 순서대로 연락드리겠습니다. 감사합니다 🙏' },
]
